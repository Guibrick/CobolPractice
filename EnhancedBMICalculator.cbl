       ...
       01 HEADING-LINE.
            ...
            05 FILLER          PIC X(22) VALUE "Height in cms".
            05 FILLER          PIC X(30) VALUE "Weight in kilos".
       ...
       0050-OPEN-FILE.
        ...
        0200-CALCULATE-BMI.
           COMPUTE WS-BMI = ( WEIGHT / (HEIGHT_CMS * HEIGHT_CMS))*10000.
           MOVE PERSON-NAME TO DET-NAME.
           MOVE HEIGHT_CMS TO DET-HEIGHT.
